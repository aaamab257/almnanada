...
class ObserverBottomNavBarContent extends StatelessWidget {
  const ObserverBottomNavBarContent({required this.controller});
  final ObserverMainController controller;
